...
<<<<<<< HEAD
  ...
  <div class="mx-auto text-center" style="width: 70%;">
    ...
    <p>
      <br>
      <br>
      O projeto Viver Bem visa promover uma alimentação saudável e ajudar em exercícios físicos para melhorar o bem-estar da população. A adoção de hábitos alimentares saudáveis e a prática regular de atividade física são importantes para uma vida saudável e para diminuir a probabilidade de desenvolver problemas de saúde, como diabetes, colesterol LDL e triglicerídeos elevados, hipertensão arterial, fadiga muscular, cansaço/desânimo, mau-humor, irritabilidade, ansiedade, estresse, dificuldades para dormir, risco de obesidade, doenças cardiovasculares e infartos.
      <p>
      O projeto tem como objetivo conscientizar as pessoas sobre a importância de adotar hábitos de vida saudáveis, especialmente em relação à alimentação e à atividade física. Além disso, o projeto visa provocar o pensamento crítico das pessoas em relação aos cuidados com o seu corpo e sua saúde, especificamente, por meio do estímulo à adoção de hábitos de vida mais saudáveis de alimentação e de atividade física.</p>
    </p>
    <br>
    <br>
    <br>

    <img src="logo.png" class="img-center rounded w-50" alt="...">
  </div>
</div>
=======
   <h1>Sobre</h1>
  <p>
a gente esta surtando fazendo esse trabalho, ainda vamos adicionar algo aquii.</p>
